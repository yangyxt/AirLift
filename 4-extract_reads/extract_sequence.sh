...
repair.sh in="${OUTPUT}/reads_1.fastq" in2="${OUTPUT}/reads_2.fastq" out="${OUTPUT}/fixed_reads_1.fastq" out2="${OUTPUT}/fixed_reads_2.fastq" outs="${OUTPUT}/singletons.fastq ain=t"
